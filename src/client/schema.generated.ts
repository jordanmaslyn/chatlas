...
/** Arguments for filtering the RootQueryToChatRoomConnection connection */
export interface RootQueryToChatRoomConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: Maybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: Maybe<Scalars['Boolean']>;
...
/** Input for the createChatRoom mutation */
...
/** Input for the deleteChatRoom mutation */
...
/** Input for the updateChatRoom mutation */
export interface UpdateChatRoomInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: Maybe<Scalars['String']>;
  /** The ID of the chatRoom object */
  id: Scalars['ID'];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars['Int']>;
  /** The password used to protect the content of the object */
...
export const generatedSchema = {
  query: {
    ...
    chatRoom: {
      __type: 'ChatRoom',
      __args: { id: 'ID!', idType: 'ChatRoomIdType', asPreview: 'Boolean' },
    },
    chatRoomBy: {
      __type: 'ChatRoom',
      __args: { id: 'ID', chatRoomId: 'Int', uri: 'String', slug: 'String' },
    },
    chatRooms: {
      __type: 'RootQueryToChatRoomConnection',
      __args: {
        first: 'Int',
        last: 'Int',
        after: 'String',
        before: 'String',
        where: 'RootQueryToChatRoomConnectionWhereArgs',
      },
    },
  ...
  mutation: {
    ...
    createChatRoom: {
      __type: 'CreateChatRoomPayload',
      __args: { input: 'CreateChatRoomInput!' },
    },
    createComment: {
    ...
    deleteChatRoom: {
      __type: 'DeleteChatRoomPayload',
      __args: { input: 'DeleteChatRoomInput!' },
    },
    deleteComment: {
    ...
    updateChatRoom: {
      __type: 'UpdateChatRoomPayload',
      __args: { input: 'UpdateChatRoomInput!' },
    },
    updateComment: {
  ...
  ChatRoom: {
    ...
    modified: { __type: 'String' },
    modifiedGmt: { __type: 'String' },
    preview: { __type: 'ChatRoomToPreviewConnectionEdge' },
    previewRevisionDatabaseId: { __type: 'Int' },
    previewRevisionId: { __type: 'ID' },
    roomDescription: { __type: 'String' },
    roomName: { __type: 'String' },
    slug: { __type: 'String' },
    status: { __type: 'String' },
    template: { __type: 'ContentTemplate' },
    templates: { __type: '[String]' },
  ...
  ChatRoomToPreviewConnectionEdge: {
    __typename: { __type: 'String!' },
    node: { __type: 'ChatRoom' },
  },
  RootQueryToChatRoomConnectionWhereArgs: {
    dateQuery: { __type: 'DateQueryInput' },
    hasPassword: { __type: 'Boolean' },
    id: { __type: 'Int' },
    in: { __type: '[ID]' },
  ...
  RootQueryToChatRoomConnection: {
    __typename: { __type: 'String!' },
    edges: { __type: '[RootQueryToChatRoomConnectionEdge]' },
    nodes: { __type: '[ChatRoom]' },
    pageInfo: { __type: 'WPPageInfo' },
  },
  RootQueryToChatRoomConnectionEdge: {
    __typename: { __type: 'String!' },
    cursor: { __type: 'String' },
    node: { __type: 'ChatRoom' },
  },
  ...
  [SchemaUnionsKey]: {
    ...
    PostObjectUnion: ['Post', 'Page', 'MediaItem', 'ChatRoom'],
...
export interface Query {
  ...
  chatRooms: (args?: {
    ...
    after?: Maybe<Scalars['String']>;
    before?: Maybe<Scalars['String']>;
    where?: Maybe<RootQueryToChatRoomConnectionWhereArgs>;
  }) => Maybe<RootQueryToChatRoomConnection>;
...
export interface ChatRoom
  extends Omit<Node, '__typename'>,
    ...
    Omit<DatabaseIdentifier, '__typename'>,
    Omit<NodeWithTemplate, '__typename'> {
  __typename: 'ChatRoom' | undefined;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  chatRoomId: ScalarsEnums['Int'];
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the ContentNode type and the ContentType type
   */
  ...
  guid?: Maybe<ScalarsEnums['String']>;
  /**
   * The globally unique identifier of the chatroom object.
   */
  id: ScalarsEnums['ID'];
  /**
   * Whether the object is a node in the preview state
  ...
  modifiedGmt?: Maybe<ScalarsEnums['String']>;
  /**
   * Connection between the chatRoom type and the chatRoom type
   */
  preview?: Maybe<ChatRoomToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums['Int']>;
   ...
   */
  previewRevisionId?: Maybe<ScalarsEnums['ID']>;
  roomDescription?: Maybe<ScalarsEnums['String']>;
  roomName?: Maybe<ScalarsEnums['String']>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums['String']>;
 ...
 * Connection between the chatRoom type and the chatRoom type
 */
export interface ChatRoomToPreviewConnectionEdge {
  __typename: 'ChatRoomToPreviewConnectionEdge' | undefined;
  /**
   * The nodes of the connection, without the edges
   */
  node?: Maybe<ChatRoom>;
...
/**
 * Connection between the RootQuery type and the chatRoom type
 */
export interface RootQueryToChatRoomConnection {
  __typename: 'RootQueryToChatRoomConnection' | undefined;
  /**
   * Edges for the RootQueryToChatRoomConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToChatRoomConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ChatRoom>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToChatRoomConnectionEdge {
  __typename: 'RootQueryToChatRoomConnectionEdge' | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the createChatRoom mutation
 */
export interface CreateChatRoomPayload {
  __typename: 'CreateChatRoomPayload' | undefined;
  /**
...
/**
 * The payload for the deleteChatRoom mutation
 */
export interface DeleteChatRoomPayload {
  __typename: 'DeleteChatRoomPayload' | undefined;
  /**
...
/**
 * The payload for the updateChatRoom mutation
 */
export interface UpdateChatRoomPayload {
  __typename: 'UpdateChatRoomPayload' | undefined;
  /**
   * The Post object mutation type.
   */
  chatRoom?: Maybe<ChatRoom>;
...
export interface SchemaObjectTypes {
  ...
  ChatRoom: ChatRoom;
  ChatRoomToPreviewConnectionEdge: ChatRoomToPreviewConnectionEdge;
  RootQueryToChatRoomConnection: RootQueryToChatRoomConnection;
  RootQueryToChatRoomConnectionEdge: RootQueryToChatRoomConnectionEdge;
  ...
  CreateChatRoomPayload: CreateChatRoomPayload;
  ...
  DeleteChatRoomPayload: DeleteChatRoomPayload;
  ...
  UpdateChatRoomPayload: UpdateChatRoomPayload;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  ChatRoomIdType: ChatRoomIdType | undefined;
